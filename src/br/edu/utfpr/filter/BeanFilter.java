 ...
 *
 */
@WebFilter(dispatcherTypes = { DispatcherType.REQUEST, DispatcherType.FORWARD }, urlPatterns = { "/roll-dice" })
public class BeanFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (isLoggedIn == null) {
			...
			List<DiceBean> beans = (List<DiceBean>) session.getAttribute("beans");
			...
			DiceBean diceBean = (DiceBean) request.getAttribute("bean");
			beans.add(diceBean);
			session.setAttribute("beans", beans);
		}
	}
